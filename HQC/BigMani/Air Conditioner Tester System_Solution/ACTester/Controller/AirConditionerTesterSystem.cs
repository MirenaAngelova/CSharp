namespace ACTester.Controller
{
    ...
    public class AirConditionerTesterSystem : IAirConditionerTesterSystem
    {
            ...
            string manufacturer, string model, string energyEfficiencyRating, int powerUsage)
        {
            ...
            {
                rating =
                    (EnergyEfficiencyRating)Enum.Parse(typeof(EnergyEfficiencyRating), 
            ...
            IAirConditioner airConditioner = 
                new StationaryAirConditioner(manufacturer, model, rating, powerUsage);
            this.Database.AirConditioners.Add(airConditioner);
            return string.Format(Constants.RegisterAirConditioner,
                airConditioner.Model, airConditioner.Manufacturer);
        }
