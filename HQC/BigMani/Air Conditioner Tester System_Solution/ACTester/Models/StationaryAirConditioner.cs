namespace ACTester.Models
{
    ...
    public class StationaryAirConditioner : AirConditioner
    {
        ...
        public StationaryAirConditioner(
            string manufacturer, string model, EnergyEfficiencyRating rating, int powerUsage)
        ...
        {
            if (this.PowerUsage <= (int)this.RequiredEnergyEfficiencyRating || 
                this.RequiredEnergyEfficiencyRating == EnergyEfficiencyRating.E)
            {
                return true;
            }
