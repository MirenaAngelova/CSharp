namespace Air_Conditioner_Testing_System.Constants
{
    public static class Constant
    {
        ...
        public const string IncorrectEnergyRating = "Energy efficiency rating must be between \"A\" and \"E\".";
        ...
        public const string NonExistEntry = "The specified entry does not exist.";
