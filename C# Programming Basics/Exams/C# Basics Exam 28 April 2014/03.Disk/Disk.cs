...
class Disk
{
    static void Main()
    {
        ...
        //Your task is to print a disk on the console by given radius R in a square field of size N x N 
        ...
        //Hint: In order to check whether a point is inside or outside of a circle, you may calculate the distance 
        //from the point to the center of the field by the Pythagorean’s theorem (see http://goo.gl/HwqOuU).
        //Constraints
        //•	The number N is a positive odd integer in the range [3…39], inclusive.
        //•	The number R is a positive integer between 1 and   (floor (N/2)), inclusive. This means that the disk will 
