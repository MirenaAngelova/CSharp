...
class House
{
    static void Main()
    {
        ...
        //You will be given an odd integer N, representing the width and the height of the house. The roof’s top starts 
        //from the center (N+1)/2 and forms a triangle with base of width N. The roof’s height is (N+1)/2. 
        //The distance between the roofs’ end point and the walls of the building is N/4, rounded down to an integer number. 
        //See the examples below to understand better these formulas.
        //Input
        ...
        {
            Console.WriteLine(new string('.',(n / 4)) + "*" + new string('.', (n - 2 - (2 * (n / 4)))) + "*" +
                        new string('.',(n / 4)));
        }
