...
class Pairs
{
    static void Main()
    {
        //You are given a number N and 2*N elements (integer numbers). The first and the second element form a pair, 
        //the third and the fourth element form a pair as well, etc. Each pair has a value, calculated as the sum of its 
        //two elements. Your task is to write a program to check whether all pairs have the same value or print the max
