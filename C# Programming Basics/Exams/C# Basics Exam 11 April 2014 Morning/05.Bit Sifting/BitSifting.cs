...
class BitSifting
{
    static void Main()
    {
        ...
        //Let the initial bits be given as 
        //165 (10100101 in binary), and the sieves be 138 (10001010), 84 (01010100) and 154 (10011010). 
        //The 1 bits from the initial number fall through the 0 bits of the sieves and stop if they reach a 1 bit; 
        //if they make it to the end, they become a part of the final number.
        //In this case, the final number is 33 (00100001), which has two 1 bits in its binary form – the answer is 1.	
        //10100101
        //↓ ↓  ↓ ↓
        //10001010
        //  ↓  ↓ ↓
        ...
        {
            ulong sieves = ulong.Parse(Console.ReadLine());
            integer = integer & ~sieves;
        }
        while (integer > 0)
        {
            count += integer & (ulong)1;
            integer = integer >> 1;
        }
        Console.WriteLine(count);
    }
