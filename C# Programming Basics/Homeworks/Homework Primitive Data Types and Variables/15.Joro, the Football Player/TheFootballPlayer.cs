...
class TheFootballPlayer
{
    static void Main()
    {
        ...
        //he always plays football with his old friends once, at Sunday. 
        //In addition, if the year is leap, Joro plays football 3 more times additionally, 
        ...
        if (year == 't')
        {
            Console.WriteLine((52 - h) * 2 / 3 + p / 2 + h + 3);
        }
        else
        {
            Console.WriteLine((52 - h) * 2 / 3 + p / 2 + h);
        }
    }
}
