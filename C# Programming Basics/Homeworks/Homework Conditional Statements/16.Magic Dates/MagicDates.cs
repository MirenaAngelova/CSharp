...
class MagicDates
{
    static void Main()
    {
        ...
        //by joining together all its digits, multiplying each digit by each of the other digits and finally sum 
        //all obtained products. In our case we will have 8-digits: 17032007, so the weight is 
        ...
        //2*0 + 2*0 + 2*7 + 
        //0*0 + 0*7 + 0*7 = 144.
        //Your task is to write a program that finds all magic dates: dates between two fixed years 
        //matching given magic weight. The dates should be printed in increasing order in format dd-mm-yyyy. 
        //We use the traditional calendar (years have 12 months, each having 28, 29, 30 or 31 days, etc.). 
