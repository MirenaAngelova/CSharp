...
class ProgrammerDNA
{
    static void Main()
    {
        ...
        //to find the DNA markers of the perfect programmer. The work is going well but after an incident with the printer 
        //in the institute it is impossible to print the latest discovery. That is why they have asked you to help them.
