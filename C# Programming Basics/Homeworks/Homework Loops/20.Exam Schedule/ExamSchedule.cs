...
class ExamSchedule
{
    static void Main()
    {
        ...
        //and there is no one else to do the job … except you of course. You will be given exam starting time 
        //in the standard 12-hour clock (hours, minutes and part of the day) and exam duration (hours and minutes). 
        //Your job is to write a program that calculates at what time the exam ends.
        ...
        //Output
        //You have to print the time the exam 
        //Constraints
        ...
        DateTime start = DateTime.Parse(string.Format("{0}:{1} {2}", hours, minutes, partOfDay));
