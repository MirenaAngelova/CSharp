namespace ClashOfKings.Engine
{
    ...
    public class Westeros : IContinent
    {
        ...
        private const string CitiesAreNotNeighboursErrorMessage = "Cannot move units: starting city and destination are not neighbors";
        ...
        public Westeros()
        {
            ...
            this.CityNeighboursAndDistances = new Dictionary<ICity, Dictionary<ICity, double>>();
        }

        public Dictionary<ICity, Dictionary<ICity, double>> CityNeighboursAndDistances { get; private set; }
        ...
        public void VerifyTroopMovement(ICity startingCity, ICity destinationCity)
        {
            ...
            if (!this.CityNeighboursAndDistances[startingCity].ContainsKey(destinationCity))
            {
                throw new LocationOutOfRangeException(CitiesAreNotNeighboursErrorMessage);
            }
            ...
            if (startingCity.FoodStorage < this.CityNeighboursAndDistances[startingCity][destinationCity])
            {
