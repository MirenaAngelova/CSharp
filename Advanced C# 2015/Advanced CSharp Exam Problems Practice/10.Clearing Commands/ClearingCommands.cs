...
public class ClearingCommands
{
    ...
    {
        //As a janitor at SoftUni you have the task to clean all the garbage, left by the students every day. 
        //The problem is you can only move through the maze of tables, chairs, internet cables and power plugs 
        //following the commands SoftUni team has left at the end of the day.
        //You are given a matrix, holding 1 or more strings of ASCII characters. The strings will come from the console, 
        //each on a separate line. These strings will contain all the garbage and commands by the SoftUni team. 
        //Your task is to find and execute all the clearing commands within the matrix. The commands are initiated 
        ...
        //Input
        //The input will be read from the console. Each line will be a string of equal length, holding ASCII characters. 
        ...
        //**********    <p>**********</p>        >basdnbdsdavd  <p>&gt;          vd</p>
        //**>****v**    <p>**&gt;    v**</p>     >asdwepoiytr<  <p>&gt;           &lt;</p>
        //**********    <p>** **** **</p>        END	       
        //**********    <p>** **** **</p>
        //**^****<**    <p>**^    &lt;**</p>
        //v*********    <p>v*********</p>		
