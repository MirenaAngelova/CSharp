...
class PINValidation
{
    static void Main()
    {
        //You’re part of a very promising team of specialists, which is hired by the parliament to recreate the new electronic 
        //government in Bulgaria.
        //Your task is to write a program that reads data about the voters in an electronic poll: first and last name, 
        //gender and PIN (EGN in Bulgarian) and then verifies the PIN. The program should generate a JSON string for DB 
        //insert if the data is correct, or print "Incorrect data" in <h2></h2> heading tags.
        //The PIN is a 10-digit number, which consists of the following:
        //•	First 6 digits are the date of birth of the citizen in format yymmdd; if the person is born before 1900, 
        //the mm digits are +20. If the person is born after 2000, the mm digits are +40
        ...
        //•	One digit for checksum. In order to get the correct checksum you need to multiply each of the first 9 digits with 
        //[2,4,8,5,10,9,7,3,6] respectively, sum all and then divide by 11. The remainder is the checksum.
        ...
        //Input
        //The input will be read from the console. The first and last name will be received on the first line. The gender 
        //will be received on the second line. The PIN will be received on the third line.
        //Output
        ...
        //Ana Ivanova
        //female
        //9912164756	{"name":"Ana Ivanova","gender":"female","pin":"9912164756"}
        //Input	Output
        //Ivan Petrov
        //male
        //1234567890	<h2>Incorrect data</h2>
