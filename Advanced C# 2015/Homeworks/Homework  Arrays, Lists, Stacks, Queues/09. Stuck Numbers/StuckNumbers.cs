...
internal class StuckNumbers
{
    static void Main()
    {
        ...
        //such that a|b == c|d, where a ≠ b ≠ c ≠ d. Assume that "a|b" means to append the number b after a. 
        //We call these numbers {a, b, c, d} stuck numbers: if we append a and b, we get the same result as if we 
