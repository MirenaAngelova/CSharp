...
internal class ZippingSlicedFiles
{
    ...
    {
        //Modify your previous program to also compress the bytes while slicing parts and decompress them when assembling
        //them back to the original file. Use GzipStream.
